...
- **Live API**: <https://api.mynakama.web.id> — OpenAPI docs at `/docs`
- **Live frontend**: <https://mynakama.web.id> — read manga, watch anime, read novels
...
- **Backend**: v2.8.5 (see [`backend/README.md`](backend/README.md) for changelog)
